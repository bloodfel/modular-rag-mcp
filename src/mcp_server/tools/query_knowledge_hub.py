...
class QueryKnowledgeHubTool:
    ...
    def _ensure_initialized(self, collection: str) -> None:
        ...
        """
        # Always rebuild on collection switch so data ingested by other
        # processes (e.g. Dashboard) is visible without a server restart.
        ...
        self._hybrid_search, self._reranker = build_query_components(
